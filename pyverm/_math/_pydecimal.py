...
#=======================================================================
#
# This file is borrowed from the CPython library, and edited to allow
# arithmetic operations between decimal and float. As well as not to
# convert float to decimal in a computer science context, but in an
# human context -> Decimal("1.1") == Decimal(1.1)
#
#=======================================================================
#
# following things got changed:
# - alowing arithmetics with floats
#   -> in function _convert_for_comparison(self, other, equality_op=False):
#      -> changed default equality_op to True
#
# - changed how float get converted
#   -> in function __new__ from float changed
...
def _convert_for_comparison(self, other, equality_op=True):
